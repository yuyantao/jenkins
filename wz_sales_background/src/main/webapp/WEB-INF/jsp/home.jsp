...
<img src="${base}/static/image/logo.png" style="width: 100%"/>
<div id="main" style="width: 100%;height:800px;display: none;"></div>
 <script type="text/javascript">
      ...
      $.ajax({
          type: "POST",
          url: "${base}/areaRanking/getChartData",
          dataType: "json",
...
<div class="Hui-article" style="display: none;">
